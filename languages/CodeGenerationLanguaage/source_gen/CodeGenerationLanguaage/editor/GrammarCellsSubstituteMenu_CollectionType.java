...
public class GrammarCellsSubstituteMenu_CollectionType extends SubstituteMenuBase {
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CollectionType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_urzvka_a extends GrammarCellsSubstituteMenuPart {
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.CollectionType$L5;
    }
  }
