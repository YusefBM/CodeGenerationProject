...
public class GrammarCellsSubstituteMenu_Entity extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Entity() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_d5n8jj_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Entity", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_d5n8jj_a extends GrammarCellsSubstituteMenuPart {
    @Override
