...
public class GrammarCellsSubstituteMenu_Attribute extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Attribute() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_chdcao_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Attribute", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_chdcao_a extends GrammarCellsSubstituteMenuPart {
    @Override
