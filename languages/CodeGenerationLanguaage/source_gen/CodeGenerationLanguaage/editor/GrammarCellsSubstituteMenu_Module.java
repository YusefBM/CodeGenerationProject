...
public class GrammarCellsSubstituteMenu_Module extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Module() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_f1ymv8_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Module", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_f1ymv8_a extends GrammarCellsSubstituteMenuPart {
    @Override
