...
public class GrammarCellsSubstituteMenu_DomainObject extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DomainObject() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_fk7q5b_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DomainObject", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_fk7q5b_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.DomainObject$Rd;
    }
  }
