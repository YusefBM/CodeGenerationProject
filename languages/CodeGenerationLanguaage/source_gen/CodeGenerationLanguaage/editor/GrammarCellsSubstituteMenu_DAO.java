...
public class GrammarCellsSubstituteMenu_DAO extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DAO() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_bqa3y3_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DAO", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_bqa3y3_a extends GrammarCellsSubstituteMenuPart {
    @Override
