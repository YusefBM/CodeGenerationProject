...
public class GrammarCellsSubstituteMenu_ValueObject extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ValueObject() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_gopwvu_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ValueObject", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_gopwvu_a extends GrammarCellsSubstituteMenuPart {
    @Override
