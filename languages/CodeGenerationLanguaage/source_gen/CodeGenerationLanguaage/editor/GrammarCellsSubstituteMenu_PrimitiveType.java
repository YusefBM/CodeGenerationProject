...
public class GrammarCellsSubstituteMenu_PrimitiveType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_PrimitiveType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_wktriq_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "PrimitiveType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_wktriq_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.PrimitiveType$5g;
    }
  }
